...
// TODO: Replace the footer tagline with your series tagline
export default function Footer() {
  ...
  return (
    <footer className="relative bg-black border-t border-primary/10">
            ...
            <div className="space-y-1">
              {books.map((book, index) => (
                <button
                  ...
                  className="text-left text-cream/40 hover:text-primary transition-colors text-sm py-1 block truncate w-full"
                >
          ...
          <div>
            ...
            <div className="space-y-2">
              <a
                ...
                className="block text-cream/40 hover:text-primary transition-colors text-base"
              >
                Buy on Amazon
              </a>
              <a
      ...
      {showScrollTop && (
        <button
          ...
          className="fixed bottom-8 right-8 w-12 h-12 rounded-full glass shadow-primary flex items-center justify-center hover:bg-primary/10 transition-all animate-fadeInScale z-50"
