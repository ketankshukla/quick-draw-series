...
- Use the same model/tool for all covers to maintain visual consistency
- Keep the same color palette across all covers
- Maintain consistent typography (same font, sizing, and positioning)
- Use the same character model across all covers for visual continuity (fiction)
